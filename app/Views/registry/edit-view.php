<form id="frm-edit-user">
    ...
    <div class="form-group col-md-12">
            <label for="txtusername">Employee ID <span class="text-danger">*</span></label>
            <input type="text" value="<?=$perspectiveRow['username']?>" class="form-control" id="txtusername" name="username" required>
            <input type="text" value="<?=$perspectiveRow['userid']?>" class="form-control" id="txtuserid" name="userid" hidden>

        </div>
        <div class="form-group col-md-3">
            <label for="txtfname">Firstname <span class="text-danger">*</span></label>
            <input type="text" value="<?=$perspectiveRow['firstname']?>" class="form-control" id="txtfname" name="firstname" required>
        </div>
        <div class="form-group col-md-3">
            <label for="txtmname">Middlename <span class="text-danger">*</span></label>
            <input type="text" value="<?=$perspectiveRow['middlename']?>" class="form-control" id="txtmname" name="middlename" >
        </div>
        <div class="form-group col-md-3">
            <label for="txtlname">Lastname <span class="text-danger">*</span></label>
            <input type="text" value="<?=$perspectiveRow['lastname']?>" class="form-control" id="txtlname" name="lastname" required>
        </div>
        <div class="form-group col-md-3">
        ...
        <script>
            $("#selsuffix").val('<?=$perspectiveRow['suffix']?>');
        </script>
        </div>
    </div>
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="email" value="<?=$perspectiveRow['email']?>" class="form-control" id="txtemail" name="email" required>
        </div>
        <div class="form-group col-md-6">
            <label for="txtmobileno">Mobile No <span class="text-danger">*</span></label>
            <input type="number" value="<?=$perspectiveRow['mobileno']?>" class="form-control" id="txtmobileno" name="mobileno" required>
        </div>
    </div>
    <div class="form-row">
        <div class="form-group col-md-6">
            <label for="txtposition">Position <small><i>(do not abbreviate)</i></small> <span class="text-danger">*</span></label>
            <input type="text" class="form-control" value="<?=$perspectiveRow['position']?>" id="txtposition" name="position" required>
        </div>
        <div class="form-group col-md-6">
            ...
            <script>
                $("#seldivision").val('<?=$perspectiveRow['divisioncode']?>');
            </script>
        </div>
    </div>
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <div>
                ...
                <script>
                    $("#sellocation").val('<?=$perspectiveRow['locationcode']?>');
                </script>
            </div>
        </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        if (divisionid) {
            ...
            setTimeout(
            function() {
                $("#selunit").val('<?=$perspectiveRow['unitid']?>');
            }, 100);
        }

        if ('<?=$perspectiveRow['is_active']?>' == 1) {
